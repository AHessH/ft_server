...
RUN		openssl req -newkey rsa:4096 -days 365 -nodes -x509 -subj '/C=RU/ST=Kazan/L=Kazan/O=Guru Project/OU=Research team/emailAddress=root@index.com/CN=localhost' -keyout localhost.dev.key -out localhost.dev.crt
